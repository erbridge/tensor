...
void DoFirstSVD(DTensor5 result[2], uint8_t sv_len[3][3], DTensor4 *B,
  ...
  uint8_t rho_A[3][3][5] = {{{0, 1, 2}, {2}, {2}}, {{2}, {0, 1, 2}, {2}},
                            {{2}, {2}, {0, 2, 2, 1, 2}}};
  uint8_t rho_B[3][3][5] = {{{0, 1, 2}, {2}, {2}}, {{2}, {1, 0, 2}, {2}},
                            {{2}, {2}, {2, 0, 2, 2, 1}}};
  uint8_t rho_M;
  uint8_t rho_N;
  uint8_t i;
  ...
  double sv_max = gsl_vector_get(S[sv_list[0][0]][sv_list[0][1]],
                                 sv_list[0][2]) *
                                     dim[sv_list[0][0]] * dim[sv_list[0][1]];
...
void OLD_DoLoopContraction(DTensor14 *C, const DTensor9 &K, const DTensor9 &SU,
  ...
  // V10, V16
  V(ContractSelf(&KKSUSUSVSV5, KKSUSUSVSV4, 6, 15));
  ...
  V(ContractSelf(&KKSUSUSVSV9, KKSUSUSVSV8, 8, 12));
